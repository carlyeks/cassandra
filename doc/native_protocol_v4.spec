...
2.2. flags
  ...
  by the mask that allow to select them):
    ...
    0x08: Warning flag. The response contains a warning from the server which
          was generated by the server to go along with this response.
          If a response frame has the warning flag set, its body contains the
          text of the warning. The warning is a [string list] and is the first
          value in the frame body if the tracing flag is not set, or directly
