...
* "@ALTER TABLE@":#alterTableStmt @ALTER@ has been dropped; a column's type may not be changed after creation
* "@ALTER TYPE@":#alterTypeStmt @ALTER@ has been dropped; a field's type may not be changed after creation
